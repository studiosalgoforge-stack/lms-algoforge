...
function Sidebar() {
  ...
  const navItems = [
    { href: '/', label: 'Dashboard', icon: (
      <svg className="w-5 h-5 mr-3 outline-none border-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
    ) },
  ...
  return (
    <div className="w-64 bg-white text-black font-bold flex flex-col min-h-screen shadow-lg shadow-[0_0_4px_rgba(0,0,0,0.03)]">
      <div className="p-6">
        <h1 className="text-xl font-bold" style={{ color: '#FFD36A' }}>AlgoForge Studios</h1>
      </div>
      <nav className="flex-1 mt-8 text-black font-bold">
        {navItems.map((item) => (
          <Link
            key={item.href}
            href={item.href}
            className={`flex items-center px-6 py-3 mb-1 rounded-xl transition-colors font-medium ${pathname === item.href ? 'bg-[#FFD6A0] text-[#232533]' : 'text-black-300 hover:bg-orange-400 bg-opacity-200 width:80% ml-1 hover:text-black'}`}
          >
            {item.icon}
            {item.label}
          </Link>
