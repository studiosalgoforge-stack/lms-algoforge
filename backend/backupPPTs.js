...
export const backupPPTs = {
  "Data-Science": [
     ...
     { 
        name: "Data Types and Infrential stastistics",
   ...
   { name: "Business moment",
    ...
    { name: "Data Minning and Hierarchical Clustering -1",
  ...
  { name: "Association Rule - 2 and Recommendation Engine - 1",
    ...
    assignments:["https://drive.google.com/uc?export=download&id=1PwgVBkdnkQsPTFACPC7t0vargZGjwk8f"
   ...
   { name: "Text Minning & Natural Language Processing (NLP) -1",
    ...
    { name: "Neural Network_Master Class",
         link:"https://docs.google.com/presentation/d/1GTQ-SWPGuSKdKSPetmhmSXlO_TJu3VW4/preview"
        , 
         assignments: [],
    },
    { name: "Convolutional Neural Network (CNN)_Master Class",
       link: "https://docs.google.com/presentation/d/1OqBeOyykd04391nSCoTWRzuDZgjIqkbB/preview" , 
       assignments:["https://drive.google.com/uc?export=download&id=1sTkp1kpeiAZ3KL-TvzHZtMisYnjWqAn9" ]},
